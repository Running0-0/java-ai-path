<table width="100%">
   <tr>
      <td align="left"><a href="../chapter-07/05-implement-transformer-java.md">&larr; 7.5 用Java实现简化版Transformer</a></td>
      <td align="right"><a href="02-bert-model.md">8.2 BERT：双向编码器表示 &rarr;</a></td>
   </tr>
</table>
---
